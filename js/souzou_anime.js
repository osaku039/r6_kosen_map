...
function showInfoBox(object) {
    ...
    const info = Info[className]['description'] || '情報が見つかりません';
    infoBox.innerHTML = `<strong>モデル名:</strong> ${object.name}<br>${className}<br><strong>情報:</strong><br> ${info}<br>
...
function showInfoBox(name) {
    ...
    infoBox.style.display = 'block';
    moveCamera(name);
>>>>>>> 4447ee35c11c9098d1f5f3207718e2a198b96aef
}
